...
import { Download, Library, LucideLibrary, Headphones, Book, Triangle, Home, User2 } from "lucide-react"
    ...
    return(
        <section className="w-full h-full flex flex-col gap-4 2xl:gap-6">
            <section className="w-full gap-1">
                <Buttons Conteudo="Inicio" hasBackground Icone={<Home color="white"/>} key={"Inicio"}/>
